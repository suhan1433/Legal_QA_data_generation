...
- [1. 관세청 데이터 이해 및 분석](#1.관세청데이터이해및분석)
- [7. 한계점 및 개선 필요 사항](#7.한계점및개선필요사항)
...
```python
"수입자는 수출자와 의약품 원료 독점계약을 체결하고 이를 원료로 A제품을 제조하고 A제품 판매에 따른 순매출액의 일부를 수출자에게 사후 지급합니다. 
업체에서는 수입물품이 아닌 수입물품을 원료로 하는 A제품 생산제품에서 발생한 수익 중 일부를 지급하는 것이므로 관련성이 없다고 주장하고 있습니다. 
A제품 판매에 따라 지급한 금액을 과세할 수 있을지 검토하시오.",
```
...
- 상황 배경 + 사실관계
    ...
    수입자(청구인)는 수출자(제3자)와 **→** **당사자 관계**
    
    의약품 원료 독점계약을 체결하고 이를 원료로 A제품을 제조하고 A제품 판매에 따른 순매출액의 일부를 수출자에게 사후 지급합니다. **→ 거래 구조**
    
    업체에서는 수입물품이 아닌 수입물품을 원료로 하는 A제품 생산제품에서 발생한 수익 중 일부를 지급하는 것
    
    **→ 지급조건**
    
    이므로 관련성이 없다고 주장하고 있습니다.  **→ 주장 차이**
...
![크롤링 결과](attachment:ca7eae05-e849-4389-a3e5-f1b282fda672:image.png)
